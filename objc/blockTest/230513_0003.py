# [Unable to use ObjCBlock in pythonista3.4 | omz:forum](https://forum.omz-software.com/topic/8097/unable-to-use-objcblock-in-pythonista3-4/10)

import ctypes
from time import sleep

from objc_util import ObjCInstance, ObjCBlock, ObjCClass
...
def Country_reverseGeocodeLocation(lat, lon):
  ...
  CLLocation = ObjCClass('CLLocation').alloc().initWithLatitude_longitude_(
    lat, lon)
  CLGeocoder.reverseGeocodeLocation_completionHandler_(CLLocation,
                                                       handler_block)
